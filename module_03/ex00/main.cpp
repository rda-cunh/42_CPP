...
int main()
{
    ...
    std::cout << "--- TEST 2: Creating a copy Claptrap, attack, clone died and threat elimination ---" << std::endl;
    std::cout << std::endl;

    ClapTrap RoboCop2(RoboCop);
    RoboCop2.setName("RoboCop Clone");
    ...
    */        
    ...
    std::cout << "RoboCop & RoboCop Clone just suffered some more damage:" << std::endl;
    RoboCop.takeDamage(3);
    RoboCop2.takeDamage(5);
